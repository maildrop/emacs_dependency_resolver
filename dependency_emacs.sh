...
dependency_dlls="libjpeg-8.dll libXpm-noX4.dll libgif-7.dll libpng16-16.dll libtiff-6.dll libxml2-2.dll librsvg-2-2.dll libwinpthread-1.dll libgnutls-30.dll libgnutlsxx-30.dll  libdbus-1-3.dll"
